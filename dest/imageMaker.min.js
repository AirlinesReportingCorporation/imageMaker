...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "2e0a29ea4fc17ac49aed";
...
/******/ 	return hotCreateRequire("./public/js/main.js")(__webpack_require__.s = "./public/js/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var scrollbarwidth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! scrollbarwidth */ "./node_modules/scrollbarwidth/scrollbarWidth.js");
/* harmony import */ var scrollbarwidth__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(scrollbarwidth__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var lodash_memoize__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash.memoize */ "./node_modules/lodash.memoize/index.js");
...
/* harmony import */ var can_use_dom__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! can-use-dom */ "./node_modules/can-use-dom/index.js");
/* harmony import */ var can_use_dom__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(can_use_dom__WEBPACK_IMPORTED_MODULE_9__);
/**
...
function () {
  function SimpleBar(element, options) {
    ...
    this.onWindowResize = function () {
      ...
      _this.scrollbarWidth = scrollbarwidth__WEBPACK_IMPORTED_MODULE_4___default()();
    ...
    this.recalculate = lodash_throttle__WEBPACK_IMPORTED_MODULE_5___default()(this.recalculate.bind(this), 64);
    this.onMouseMove = lodash_throttle__WEBPACK_IMPORTED_MODULE_5___default()(this.onMouseMove.bind(this), 64);
    this.hideScrollbars = lodash_debounce__WEBPACK_IMPORTED_MODULE_6___default()(this.hideScrollbars.bind(this), this.options.timeout);
    this.onWindowResize = lodash_debounce__WEBPACK_IMPORTED_MODULE_6___default()(this.onWindowResize.bind(this), 64, {
      leading: true
    });
    SimpleBar.getRtlHelpers = lodash_memoize__WEBPACK_IMPORTED_MODULE_7___default()(SimpleBar.getRtlHelpers); // getContentElement is deprecated
  ...
  _createClass(SimpleBar, [{
    ...
    value: function init() {
      ...
      if (can_use_dom__WEBPACK_IMPORTED_MODULE_9___default.a) {
        this.initDOM();
        this.scrollbarWidth = scrollbarwidth__WEBPACK_IMPORTED_MODULE_4___default()();
        this.recalculate();
        this.initListeners();
      }
    }
    ...
    value: function initListeners() {
      ...
      this.resizeObserver = new resize_observer_polyfill__WEBPACK_IMPORTED_MODULE_8__["default"](this.recalculate);
...
__webpack_require__(/*! ../css/main.scss */ "./public/css/main.scss");
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; } //css imports
...
var data = {
  ...
  templates: [{
    ...
    logoColor: "teal",
    logoPosition: "topRight"
  }, _defineProperty(_ref, 'logoSize', "small"), _defineProperty(_ref, 'logoColor', "teal"), _defineProperty(_ref, 'logoPosition', "topRight"), _defineProperty(_ref, 'imageIcon', ''), _defineProperty(_ref, 'textAlign', 'left'), _defineProperty(_ref, 'text', [{
    copy: 'We\'re Hiring!',
    class: 'Source Sans Pro Black, SourceSansPro-Black, arial, sans-serif',
    color: '#0C1C47',
    size: '48px'
...
_vue2.default.component('image-item', {
  template: ''
});
...
var app = new _vue2.default({
  ...
  computed: {
    ...
    borderFormat: function borderFormat() {
      var obj = {};
    ...
    backgroundFormat: function backgroundFormat() {
      var val = 'url("' + this.background + '") center center/cover no-repeat !important';
      return val;
    }
  },
  methods: {
    setCurrentTemplate: function setCurrentTemplate(e) {
    ...
    saveImage: function saveImage() {
      htmlToImage.toPng(document.getElementById('myImage'), { cacheBust: true }).then(function (dataUrl) {
...
/******/ });
//# sourceMappingURL=imageMaker.min.js.map